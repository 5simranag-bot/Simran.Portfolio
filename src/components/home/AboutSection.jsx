...
export default function AboutSection() {
  return (
    <section
      ...
      style={{ paddingTop: 'clamp(52px,7vw,96px)', background: 'linear-gradient(180deg,#e8dcc8 0%,#f4eddf 30%,#efe6d6 100%)' }}
    >
      <div className="relative z-3 max-w-[1120px] mx-auto px-[clamp(22px,6vw,64px)]">
        ...
        <div className="relative grid grid-cols-1 xl:grid-cols-[1.3fr_1fr] gap-[clamp(34px,6vw,80px)] items-start" style={{ marginTop: 'clamp(24px,4vw,44px)' }}>
          <div>
            ...
            <Reveal delay={180} className="flex flex-wrap gap-[10px]" style={{ marginTop: 20 }}>
              {principles.map((p) => (
                <span
                  key={p}
            ...
            <Reveal delay={240} className="flex gap-[clamp(24px,5vw,52px)]" style={{ marginTop: 28 }}>
              {stats.map((s) => (
      ...
      <div className="relative" style={{ height: 'clamp(130px,16vw,210px)', marginTop: 'clamp(20px,3vw,44px)' }}>
        <ParallaxLayer
          as="svg"
          anchor="about"
          speed={0.07}
