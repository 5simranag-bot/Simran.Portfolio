...
export default function ProcessSection() {
  return (
    <section
      ...
      style={{ padding: 'clamp(52px,7vw,96px) 0 0', background: 'linear-gradient(180deg,#efe3cf 0%,#eae3d6 40%,#e4ddd0 100%)' }}
    >
      <div className="relative z-3 max-w-[1180px] mx-auto px-[clamp(22px,6vw,64px)]">
        ...
        {/* process path */}
        <div className="relative" style={{ marginTop: 'clamp(24px,4vw,48px)' }}>
          <div
            aria-hidden="true"
        ...
        {/* methods + frameworks */}
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-[clamp(24px,4vw,52px)]" style={{ marginTop: 'clamp(24px,4vw,52px)' }}>
          <Reveal>
      ...
      {/* mountain footer */}
      <div className="relative" style={{ height: 'clamp(100px,12vw,160px)', marginTop: 'clamp(24px,4vw,52px)' }}>
        <ParallaxLayer
          as="svg"
          anchor="process"
          speed={0.07}
