      ...
      >
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-3 rounded-full text-[13px] uppercase transition-all duration-300 hover:bg-terracotta hover:text-[#f4ead9] hover:border-terracotta"
            style={{ letterSpacing: '.18em', color: '#b14b34', border: '1.5px solid #b14b34', padding: '14px 36px', background: 'rgba(246,239,226,0.72)', backdropFilter: 'blur(6px)', WebkitBackdropFilter: 'blur(6px)' }}
          >
