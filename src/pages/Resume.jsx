...
export default function Resume() {
  return (
    ...
    >
      <Helmet>
        <title>Résumé — Simran Agarwal | Senior UX Designer</title>
        <meta name="description" content="Résumé of Simran Agarwal, Senior UX Designer with 5+ years at Michelin, Metafic and Warpspd. Expert in enterprise SaaS, design systems, data visualisation and UX research." />
        {SITE && <link rel="canonical" href={`${SITE}/resume`} />}
        {SITE && <meta property="og:url" content={`${SITE}/resume`} />}
        <meta property="og:title" content="Résumé — Simran Agarwal | Senior UX Designer" />
        <meta property="og:description" content="Résumé of Simran Agarwal, Senior UX Designer with 5+ years at Michelin, Metafic and Warpspd." />
        <meta name="twitter:title" content="Résumé — Simran Agarwal | Senior UX Designer" />
        <meta name="twitter:description" content="Résumé of Simran Agarwal, Senior UX Designer with 5+ years at Michelin, Metafic and Warpspd." />
      </Helmet>

      {/* toolbar (screen only) */}
      <div className="no-print w-full max-w-[820px] flex items-center justify-between gap-[10px]">
        <Link to="/" className="inline-flex items-center gap-[6px] text-[11px] sm:text-[13px] rounded-full whitespace-nowrap" style={toolbarLinkStyle}>
          ←<span className="hidden sm:inline"> Back to the journey</span><span className="sm:hidden"> Back</span>
        </Link>
        <div className="flex items-center gap-[8px]">
          <a href="/assets/Simran-Agarwal-Resume.pdf" download="Simran-Agarwal-Resume.pdf" className="inline-flex items-center gap-[5px] text-[11px] sm:text-[13px] rounded-full whitespace-nowrap" style={toolbarLinkStyle}>
            <span className="hidden sm:inline">Download </span>PDF<span aria-hidden="true">↓</span>
          </a>
          <button
            onClick={() => window.print()}
            className="inline-flex items-center gap-[5px] text-[11px] sm:text-[13px] rounded-full border-none whitespace-nowrap"
            style={{ letterSpacing: '.04em', color: '#f6efe2', background: '#b14b34', padding: '9px 14px' }}
          >
            <span className="hidden sm:inline">Save as </span>PDF<span aria-hidden="true">⎙</span>
          </button>
        </div>
      </div>
